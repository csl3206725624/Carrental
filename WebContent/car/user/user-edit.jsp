...
<article class="page-container">
	<form  action="<%=request.getContextPath() %>/user.do?method=edit" method="post" onsubmit="return checkForm(form1)" enctype="multipart/form-data">
	
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>车辆编号：</label>
		<div class="formControls col-xs-8 col-sm-9">
			 <td><input type="text" style="width:300px" class="input-text" value="${map.user_id }" placeholder="添加编号" id="user-email" name="user_id">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" style="width:200px" class="input-text" value="${map.user_Plate}" placeholder="添加车牌" id="user-name" name="user_Plate" datatype="*2-16" nullmsg="车牌不能为空">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" style="width:300px" class="input-text" value="${map.user_Model}" placeholder="添加型号" id="user-tel" name="user_Model">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>车辆颜色：</label>
		<div class="formControls col-xs-8 col-sm-9">
			 <td><input type="text" style="width:300px" class="input-text" value="${map.user_Color }" placeholder="添加颜色" id="user-email" name="user_Color">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			 <!--  
			 <td><input type="text" style="width:300px" class="input-text" value="${map.user_Imgpath }" placeholder="添加图片" id="user-email" name="user_Imgpath">
			-->
			 <td> <span id="spid"><input   type="file"  value="${map.user_Imgpath }" placeholder="添加图片"  name="user_Imgpath"  onchange="imgPreview(this)"   id="imgFile"/></span></td>
		         <td rowspan="3"><img id="preview"   style="width:130px;height:130px"  src="<%=request.getContextPath()%>/image/touxiang.png"  /></td>
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			...
			<option value="已租"  ${ "已租"  eq  map.user_State ?  "selected" : "" }>已租</option>
			<option value="未租"  ${ "未租"  eq  map.user_State ?  "selected" : "" }>未租</option>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			 <td><input type="text" style="width:300px" class="input-text" value="${map.user_Gongying }" placeholder="供应商" id="user-email" name="user_Gongying">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			 <td><input type="text" style="width:300px" class="input-text" value="${map.user_Yonghu }" placeholder="用户" id="user-email" name="user_Yonghu">
